...
function Footer() {
    return (
        <div>
            <footer className="dark:bg-gray-100 text-white max-w-[1200px] mx-auto">
                <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row dark:divide-gray-600">
                    ...
                    <div className="flex flex-col justify-center pt-6 lg:pt-0">
                        <div className="flex justify-center space-x-4">
                            ...
                            <a rel="noopener noreferrer" href="https://x.com/MahenHowlader" title="Twitter" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-600 dark:text-gray-50">
                            ...
                            <a rel="noopener noreferrer" href="https://web.facebook.com/profile.php?viewas=100000686899395&id=61562073142361" title="Facebook" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-600 dark:text-gray-50">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
